...
async def handle_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "Create Folder Link":
        ...
        await update.message.reply_text("Send me a URL to shorten. Example: https://example.com")
        ...
        status_text = (
            ...
            f"• Custom Caption: {'✅' if settings and settings['custom_caption'] else '❌'}\n"
            f"• Protect Content: {'✅' if settings and settings['protect_content'] else '❌'}\n"
            f"• Auto Delete: {'✅' if settings and settings['auto_delete'] else '❌'}"
        )
...
# Handle URL for shortening from menu
...
def main():
    ...
    application.add_handler(MessageHandler(filters.Document.ALL | filters.PHOTO | filters.VIDEO | filters.AUDIO, handle_files))
